...
export default class Agua15 extends Enemy {

    constructor(scene, x, y) {
        super(scene, x, y, "agua15");
        this.nombre = "agua15";
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 11, end: 12 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 9, end: 10 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 3, end: 4 }),
            frameRate: 4,
            repeat: 0
        });
