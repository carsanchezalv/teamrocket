...
export default class Agua12 extends Enemy {

    constructor(scene, x, y) {
        super(scene, x, y, "agua12");
        this.nombre = "agua12";
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 7, end: 7 }),
            frameRate: 4,
            repeat: 0
        });
