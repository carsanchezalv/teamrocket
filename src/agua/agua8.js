...
export default class Agua8 extends Enemy {

    constructor(scene, x, y) {
        super(scene, x, y, "agua8");
        this.nombre = "agua8";
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 48, end: 49 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 45, end: 46 }),
            frameRate: 4,
            repeat: 0
        });
