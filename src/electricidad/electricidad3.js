...
export default class Electricidad3 extends Enemy {

    constructor(scene, x, y) {
        super(scene, x, y, "electricidad3");
        this.nombre = "electricidad3";
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 11, end: 11 }),
            frameRate: 4,
            repeat: 0
        });
