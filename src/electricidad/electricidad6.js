...
export default class Electricidad6 extends Enemy {

    constructor(scene, x, y) {
        super(scene, x, y, "electricidad6");
        this.nombre = "electricidad6";
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 46, end: 46 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 48, end: 48 }),
            frameRate: 4,
            repeat: 0
        });
