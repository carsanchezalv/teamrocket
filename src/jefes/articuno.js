...
export default class Articuno extends Enemy {

    constructor(scene, x, y) {
        super(scene, x, y, "articuno");
        this.nombre = "articuno";
        this.animation = "move_down_enemy"+this.nombre;
        this.vida = 300;
        if(data.nivel === 1.5)
            this.factorFuerza = 1.4;
        else if (data.nivel === 0.5)
            this.factorFuerza = 0.6;
        else
            this.factorFuerza = 1;
        this.fuerza = 12 * this.factorFuerza;
