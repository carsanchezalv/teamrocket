...
export default class Fuego12 extends Enemy {

    constructor(scene, x, y) {
        super(scene, x, y, "fuego12");
        this.nombre = "fuego12";
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 38, end: 40 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 41, end: 43 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 35, end: 37 }),
            frameRate: 4,
            repeat: 0
        });
