...
export default class Fuego8 extends Enemy {

    constructor(scene, x, y) {
        super(scene, x, y, "fuego8");
        this.nombre = "fuego8";
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 33, end: 35 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 42, end: 44 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 49, end: 51 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 45, end: 47 }),
            frameRate: 4,
            repeat: 0
        });
        ...
        this.scene.anims.create({
            ...
            frames: this.scene.anims.generateFrameNumbers(this.nombre, { start: 37, end: 39 }),
            frameRate: 4,
            repeat: 0
        });
